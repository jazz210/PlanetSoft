...
<body >
	...
	<section class="pagina">
		<div class="cuerpo">
			...
			<div class="mapaA" id="mapaA">
				...
				<div class="mapa" id="mapa">
					...
					<?php
								...
								$b = $mostrar['bloque'];	
					?>
								<div class="ocupado" onclick="mostrarInfo('<?php echo $n;?>', '<?php echo $p;?>', '<?php echo $no;?>', '<?php echo $b;?>');"><?php echo $mostrar['numero']?></div>
					<?php
							}
						}
					?>
			...
			<button class="botonAceptar2" name ="botonAceptar" onclick="location.href='reserva.php'">Volver</button>
		</div>
	</section>
